      ...
      {action === 'new' && (
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className="flex gap-2">
            <input type="text" id="photoLink" placeholder="Add using a link" {...formik.getFieldProps("photoLink")} />
            <button className="bg-gray-200 px-4 rounded-2xl w-32">Add photo</button>
          </div>
          <div className="mt-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
            <button className="flex gap-1 items-center justify-center border bg-transparent rounded-2xl p-6 text-2xl text-gray-600">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
